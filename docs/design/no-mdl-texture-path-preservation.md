...
- `docs/design/no-mdl-texture-path-handling.md`：现有行为的完整分析（本功能的问题来源文档）
- `docs/design/no-mdl-materials.md`：`materials.py` 的详细说明
- `docs/design/architecture-flow.md`：整体处理流程
