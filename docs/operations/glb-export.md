...
-   **[Architecture](../design/glb-architecture.md)**: High-level design, class roles, and limitations.
-   **[Code Walkthrough](../design/glb-code-walkthrough.md)**: **Recommended for Beginners**. A line-by-line explanation of how the conversion works.

> **中文文档 (Chinese Documentation)**:
> - [GLB 导出说明 (README)](glb-export-zh.md)
> - [架构设计 (Architecture)](../design/glb-architecture-zh.md)
> - [代码导读 (Code Walkthrough)](../design/glb-code-walkthrough-zh.md)
...
For a deep dive into specific logic (like how we handle UVs or Binary writing), refer to the **[Code Walkthrough](../design/glb-code-walkthrough.md)**.
