...
- 官方 soap-to-dish 修复：`official_ebench_scene@e1cf0d5b4d76` 已通过 formal no-MDL + AAN static/runtime package 路线，证据见 [formal package runtime report](records/evidence/2026-07-05-soap-to-dish-official-asset-closure/formal_package_runtime_report.yaml)；
