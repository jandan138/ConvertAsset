...
- camera/thumbnails/target-capture：为资产缩略图、对象级定位和多视角拍摄提供 orbit camera framing；
- docs：采用 Genesis-LLM 风格的 purpose-based taxonomy。

## 新增入口

- [Scene target capture design](design/target-capture.md)
- [Target capture operations](operations/target-capture.md)
- [2026-05-14 target capture record](records/2026-05-14-target-capture.md)
