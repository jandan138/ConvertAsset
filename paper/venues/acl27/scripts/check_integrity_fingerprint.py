...
DEFAULT_SOURCE_PATTERNS = (
    ...
    "venues/acl27/preamble.tex",
    "venues/acl27/sections/*.tex",
    "shared/sections/appendix.tex",
    "shared/tables/*.tex",
    "shared/references.bib",
    "shared/figures/fig_acl_method_chain_imagegen_v18.png",
    "shared/figures/prompts/fig_acl_method_chain_gpt_image2_v18.prompt.txt",
    "shared/figures/gen_figures.py",
    "shared/figures/fig_render_pairs.pdf",
    "shared/figures/fig_grscene_qualitative.pdf",
    "shared/figures/gen_render_scene_evidence_wide.py",
    "shared/figures/fig_render_scene_evidence_wide.png",
    "shared/figures/gen_material_effect_qualitative.py",
    "shared/figures/fig_material_effect_baseline_qualitative.png",
    "shared/figures/fig_material_effect_baseline_qualitative.report.json",
    "shared/figures/fig_internnav_rollout_0036_0066_main3_readable.png",
    "shared/figures/fig_internnav_rollout_0036_0066_column.png",
    "shared/figures/gen_internnav_main_readable.py",
    "venues/acl27/OPENREVIEW_METADATA_PACKET.md",
    "venues/acl27/OPENREVIEW_RESPONSIBLE_NLP_CHECKLIST.md",
    "venues/acl27/ARTIFACT_PROVENANCE_DRAFT.md",
    ...
    "shared/evidence/raw/material_effect_baseline/qualitative_render_manifest.json",
