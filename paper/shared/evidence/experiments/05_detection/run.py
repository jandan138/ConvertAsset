...
Usage:
    ...
    python paper/shared/evidence/experiments/05_detection/run.py
"""
...
RENDERS_DIR = PROJECT_ROOT / "paper" / "shared" / "evidence" / "raw" / "renders"
OUTPUT_JSON = PROJECT_ROOT / "paper" / "shared" / "evidence" / "raw" / "detection_results.json"
