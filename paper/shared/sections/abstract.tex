...
further add a GRScenes vision-language grounding pilot over matched
original/converted renders, separating a 15-pair clean visual-QA pool from a
14-pair material-shift stress pool; these results expose model- and
coordinate-protocol sensitivity rather than supporting a final benchmark claim.
We
...
synthetic data practitioners on when material simplification appears low-risk
