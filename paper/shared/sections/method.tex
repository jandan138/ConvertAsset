...
For the vision-language grounding extension, we use the original GRScenes scene
tree read-only and materialize converted counterparts in a scratch workspace.
