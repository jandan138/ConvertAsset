...
and shader complexity become substantial. However, the repeated official
KuJiaLe scene benchmark does not reproduce the same speedup: original MDL and
noMDL have overlapping warmed-ready confidence intervals across the three
official scenes. We therefore treat performance as scene-family dependent
rather than as a universal consequence of noMDL conversion. The clearest
general benefit in this study remains interoperability: UsdPreviewSurface materials are supported by
