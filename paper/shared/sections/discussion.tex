...
\paragraph{When does simplification appear low-risk?}
Our results across three evaluation dimensions consistently indicate that
MDL-to-UsdPreviewSurface conversion appears low-risk for tested assets whose
...
The GRScenes pilot shows why feature similarity and qualitative scene fidelity
...
for normalized coordinates. In the zoom-stress pool, Gemma4 remains stable
while Qwen shows answer and raw-point degradation on converted renders. This
does not imply that conversion generally harms VLM grounding; rather, it shows
that the effect is model- and protocol-dependent, and that clean-preservation
pools must be separated from material-shift stress tests.
