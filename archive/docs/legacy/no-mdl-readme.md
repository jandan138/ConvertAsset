...
Archived snapshot: this file preserves the old no-MDL index. Some inline paths
below refer to the pre-refactor layout; use `docs/design/`,
`docs/operations/`, and `docs/records/` for current navigation.
